...
4. On the training set pick prediciton function.
5. Apply prediction funciton on the training data set.
6. Apply the prediciton on validaiton data set.
...
The total_accel_arm and total_accel_forearm featurs shows better distribution curve compared to all other features.
...
## Final predtiction with test/validation data set
